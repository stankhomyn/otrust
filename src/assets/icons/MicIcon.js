...
export function MicOnIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32">
      <path
        fill="#939bab"
        d="M16 18.667a3.983 3.983 0 003.987-4l.013-8a4 4 0 10-8 0v8a4 4 0 004 4zm7.067-4a6.918 6.918 0 01-7.067 6.8 6.918 6.918 0 01-7.066-6.8H6.667a9.312 9.312 0 008 8.96V28h2.667v-4.373a9.29 9.29 0 008-8.96z"
      />
