      ...
      <ModalBody>
        ...
        <BridgeWrapper>
          ...
          <BridgeContentWrapper>
            ...
            <BridgeText>
              Welcome to Onomy Bridge! Right now you need to connect your Onomy Access wallet to be
              able to bridge assets from Bonding Curve. Please scan this QR code with your Onomy
              Access app
            </BridgeText>
            <DirectoryQR>
